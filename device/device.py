...
# Header CSV
FIELDNAMES = ["TS", "pv_voltage", "pv_current", "pv_power", "battery_voltage", "battery_charger_current", "device_current", "device_power", "raspi_temperature", "cpu_usage", "ram_used", "ram_total", "ram_percent", "disk_free", "disk_total", "disk_used", "disk_percent"]
...
def get_system_stats():
    ...
    return {
        "cpu_usage": cpu_usage,
        "ram_used": round(ram_usage.used / (1024 ** 3), 3),
        "ram_total": round(ram_usage.total / (1024 ** 3), 3),
        "ram_percent": round(ram_usage.percent, 3),
